class newsApi {
    ...
    getSearchNews(keyWord){
        return fetch(`https://nomoreparties.co/news/v2/everything?q=${keyWord}&from=2021-01-24&to=2021-01-24&language=ru&pageSize=10&apiKey=b3701453d6ca442ab895e448e1aeb444` , {
            headers: {
                'Content-Type': 'application/json'
            }
        })
